...
Status: PASS
Config: `network_configs\test_1.json`
Duration: 20.0 s
Time step: 0.05 s
Steps: 400
...
- `nodes_csv`: `results\test_1\nodes.csv`
- `connections_csv`: `results\test_1\connections.csv`
- `summary_json`: `results\test_1\summary.json`
- `nodes_summary_json`: `results\test_1\nodes_summary.json`
- `connections_summary_json`: `results\test_1\connections_summary.json`
- `diagnostics_json`: `results\test_1\diagnostics.json`
- `report_json`: `results\test_1\report.json`
- `report_markdown`: `results\test_1\report.md`
- `nodes_plot`: `results\test_1\nodes.png`
- `connections_plot`: `results\test_1\connections.png`
